...
const styles = {
  button: (color: Choice) =>
    cn(
      "w-40 h-40 max-[480px]:w-32.5 max-[480px]:h-32.5 rounded-full border-2 border-transparent",
      "cursor-pointer font-display text-base max-[480px]:text-[0.85rem] font-black tracking-[0.18em]",
      "uppercase text-white transition-shadow duration-200 relative flex items-center justify-center",
